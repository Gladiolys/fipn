    ...
    final public static function loadClass(string $class): void
    {
        ...
        if (strpos($class, '_PHPStan_') === 0) {
            ...
            if (self::$composerAutoloader === null) {
                ...
                include_once 'phar://' . __DIR__ . '/phpstan.phar/vendor/clue/block-react/src/functions_include.php';
                include_once 'phar://' . __DIR__ . '/phpstan.phar/vendor/jetbrains/phpstorm-stubs/PhpStormStubsMap.php';
                include_once 'phar://' . __DIR__ . '/phpstan.phar/vendor/react/promise-stream/src/functions_include.php';
